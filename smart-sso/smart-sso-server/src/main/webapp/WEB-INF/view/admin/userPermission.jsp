...
<jsp:include page="../common/common.jsp">
	<jsp:param name="title" value="用户授权"/>
</jsp:include>
...
<div class="row">
	<div class="col-xs-12">
		...
		<form id="_editForm" class="form-horizontal" role="form" 
			validate="true">
			<input name="userId" type="hidden" value="${userId}" required="true">
		...
		jQuery(function($) {
			...
			$("#_submit").click(function(){
				if($('#_editForm').validate()){
					...
					$.post("${_path}/admin/userPermission/save", $.extend($.formJson('_editForm'), {"isEnable" : true, 'permissionIds' : permissionIds}), function(d) {
						if(d){
							btn.button('reset');
							if(d.code == 1){
